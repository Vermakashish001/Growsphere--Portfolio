          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <div>
              ...
              <div className="flex space-x-3">
                ...
                <a href="https://www.instagram.com/growsphere007/" className="w-10 h-10 bg-gray-800/50 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary-600 transition-all duration-300 transform hover:scale-110">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
